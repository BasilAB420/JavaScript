...
function capitalizeNames(arr) {
    ...
    for (i = 0; i < arr.length; i++) {
        ...
        stored.push(arr[i].toLowerCase());
        stored[i] = stored[i].charAt(0).toUpperCase() + stored[i].substr(1, stored[i].length - 1);//concatination the first litter with the rest of the string.
